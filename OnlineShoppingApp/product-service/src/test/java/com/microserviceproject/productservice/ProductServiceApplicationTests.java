...
// Creating integration test to test if post and get are working or not
@SpringBootTest
@Testcontainers
...
//	}
	...
	void shouldCreateProduct() throws Exception {
		...
		//	since .content takes type string we convert productRequest using ObjectMapper to json
